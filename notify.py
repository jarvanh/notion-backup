...
push_config = {
    ...
    'QYWX_AM': '',  # 企业微信应用
    'QYWX_KEY': '',  # 企业微信机器人
    'TG_BOT_TOKEN': os.getenv('TELEGRAM_BOT_TOKEN', ''),  # 必填！ tg 机器人的 TG_BOT_TOKEN，例：1407203283:AAG9rt-6RDaaX0HBLZQq0laNOh898iFYaRQ
    'TG_USER_ID': os.getenv('TELEGRAM_CHAT_ID', ''),  # 必填！ tg 机器人的 TG_USER_ID，例：1434078534
